...
#                     CREATE INDEX IF NOT EXISTS idx_maintenance_history_failure_code ON maintenance_history(failure_code);
#                 """
#                 )
...
#                         issuing_body VARCHAR(100) NOT NULL, -- e.g., 'PESO', 'OISD', 'OSHA'
#                         title TEXT NOT NULL,
#                         last_updated DATE
#                     );
...
#                         measured_parameters JSONB -- E.g., {"wall_thickness_mm": 12.5, "pressure_test_psi": 150}
#                     );
...
#                 cur.execute("""
#                     -- Phase 5: Historical Incidents & Lessons Learned
#                     CREATE TABLE IF NOT EXISTS historical_incidents (
#                         incident_id VARCHAR(50) PRIMARY KEY,
#                         asset_category VARCHAR(100) NOT NULL, -- e.g., 'CENTRIFUGAL_PUMP', 'COMPRESSOR'
...
#                     -- B-Tree index for the hard SQL pre-filter
#                     CREATE INDEX idx_incident_category ON historical_incidents(asset_category);

#                     -- HNSW index for high-speed cosine similarity vector search
